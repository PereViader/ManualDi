...
namespace ManualDi.Async.Generators
{
    ...
    public class ManualDiInjectableSourceGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            var classData = context.SyntaxProvider
                .ForAttributeWithMetadataName(
                    "ManualDi.Async.ManualDiInjectableAttribute",
                    IsSyntaxNodeValid,
                    GetClassData)
        ...
        private static void GenerateRegistration(SourceProductionContext context, AssemblyFlags flags, ImmutableArray<ClassData> classes)
        {
            ...
            stringBuilder.AppendLine("namespace ManualDi.Async");
            stringBuilder.AppendLine("{");
        ...
        private readonly struct WellKnownTypes(Compilation compilation)
        {
            ...
            public readonly INamedTypeSymbol? ManualDiInjectableAttribute = compilation.GetTypeByMetadataName("ManualDi.Async.ManualDiInjectableAttribute");
