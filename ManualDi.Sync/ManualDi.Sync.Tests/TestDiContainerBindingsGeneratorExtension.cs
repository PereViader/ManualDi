...
namespace ManualDi.Sync.Tests
{
    ...
    public static class CustomExtensionManualDiExtensions
    {
        ...
        {
            return binding
                .Initialize((o, c) => ((ICustomExtension)o).CallLog.Add("Initialize"))
                .Dispose((o, c) => ((ICustomExtension)o).CallLog.Add("Dispose"));
        }
    }
    ...
    {
        [Test]
        public void TestGeneratorExtension_RunsHook()
        {
        ...
        [Test]
        public void TestGeneratorExtension_DeduplicatesHookOnInheritance()
        {
            var callLog = new List<string>();
            using (var diContainer = new DiContainerBindings().Install(b =>
            {
