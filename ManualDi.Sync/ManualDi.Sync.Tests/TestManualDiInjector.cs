...
namespace ManualDi.Sync.Tests
{
    public class TestManualDiInjector
    {
        ...
        [Test]
        public void TestInheritanceWithInBetweenUnmarkedClass()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
        ...
        [Test]
        public void TestMultiLevelSkipping()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
        ...
        [Test]
        public void TestDerivedWithoutDirectInjectMethod()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
        ...
        [Test]
        public void TestComplexParameterResolutions()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
        ...
        {
            using var diContainer = new DiContainerBindings().Build();
...
";
        ...
        [Test]
        public void TestFiveLevelInterleavedInheritance()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
        ...
        [Test]
        public void TestCustomManualRegistration()
        {
            using var diContainer = new DiContainerBindings().Install(b =>
            {
